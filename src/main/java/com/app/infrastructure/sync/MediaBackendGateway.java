...
public class MediaBackendGateway {

    private final ConfigProvider configProvider;

    public MediaBackendGateway(ConfigProvider configProvider, AuthenticatedHttpClient authenticatedHttpClient) {
        this.configProvider = Objects.requireNonNull(configProvider);
    }

    public Map<String, Media> fetchMediaById() {
        ...
        String sql = "SELECT id, type, url, file_extension, neighbourhood_id, event_id FROM media";
        ...
        try (Connection conn = DriverManager.getConnection(jdbcUrl);
            ...
            DailyLogger.logInfo("Sync", "Fetched " + byId.size() + " media from PostgreSQL.");
        } catch (Exception e) {
            DailyLogger.logError("Sync", "Failed to fetch media: " + e.getMessage(), e);
        }
        return byId;
    }
